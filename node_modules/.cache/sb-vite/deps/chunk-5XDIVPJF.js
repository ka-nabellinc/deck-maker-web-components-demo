...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-WTYKIUP3.js";
import {
  ActionBar
} from "./chunk-XYWWRPCZ.js";
import {
  ThemeProvider,
  convert,
  ensure,
...
import {
  require_pickBy
} from "./chunk-PIWKXMEC.js";
import {
  require_uniq
} from "./chunk-YU53WGFD.js";
import {
  require_mapValues
} from "./chunk-4NLZEZAF.js";
import {
  require_cloneDeep
} from "./chunk-7QTK3VXE.js";
import {
  __commonJS,
  __toESM
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-5CCJA4MC.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-MEAGWALO.js"));
...
var WithCallback = ({ callback, children }) => {
  let once2 = (0, import_react2.useRef)();
...
var renderElement = async (node, el) => {
  ...
  return new Promise((resolve) => {
    root.render(import_react2.default.createElement(WithCallback, { callback: () => resolve(null) }, node));
  });
};
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./@mdx-js_react.js").then(({ MDXProvider }) => renderElement(import_react3.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react3.default.createElement(MDXProvider, { components }, import_react3.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=chunk-5XDIVPJF.js.map
